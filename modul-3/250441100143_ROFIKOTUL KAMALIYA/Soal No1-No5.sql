CREATE DATABASE manajemen_inventaris_gudang;
USE manajemen_inventaris_gudang;
...
(101, 'Gaming Laptoop G5', 'ELEC-442-X', 'Laptop', 15500000, 12, 'A-01', 'Lulus'),
(102, 'Wireles Mouse', 'ACC-101-Y', 'Aksesoris', 250000, 150, NULL, 'Lulus'),
...
SELECT DISTINCT kode_sku FROM inventaris_gudang_pusat
...
ELSE 'Aman'
END AS prioritas_restok
FROM inventaris_gudang_pusat
ORDER BY stok ASC;

SELECT * FROM inventaris_gudang_pusat
WHERE lokasi_rak LIKE 'B%' AND NOT (harga_satuan BETWEEN 1000000 AND 5000000) AND kategori<>'Monitor';
